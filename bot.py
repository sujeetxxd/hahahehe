        ...
        try:
            ...
            if task_key in context.bot_data:
                ...
                if expected_items_for_task > 0 and relayed_count < expected_items_for_task:
                    ...
                    await context.bot.send_message(chat_id=requester_chat_id, text=f"ℹ️ Helper finished for '{button_label}', but there might be a mismatch in counts. Relayed by bot: {relayed_count} out of {expected_items_for_task} expected.")
